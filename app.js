...
const defaultCards = [
  ...
  upgrade("diamond-corrupt-dealer", "diamond", "Dealer Bị Mua", "Bài", "Đến hết trận, mỗi vòng 1 lần, yêu cầu chia lại 1 lá cho bạn hoặc cho một đối thủ trước showdown."),
  ...
  upgrade("cheat-finisher", "cheat", "Dấu Chấm Hết", "Snowball", "Đến hết trận, mỗi khi bạn thắng showdown, đánh dấu người thua nhiều nhất. Nếu một người có 2 dấu, họ mất nửa bankroll hiện tại và bạn nhận phần đó."),
